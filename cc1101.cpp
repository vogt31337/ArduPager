...
#define cc1101_Select()  SPI.beginTransaction(SPISettings(2000000, MSBFIRST, SPI_MODE0));digitalWrite(BIT_SPI_SS, LOW)
// Deselect (SPI) CC1101
//#define cc1101_Deselect()  bitSet(PORT_SPI_SS, BIT_SPI_SS);
#define cc1101_Deselect()  digitalWrite(BIT_SPI_SS, HIGH);SPI.endTransaction();
